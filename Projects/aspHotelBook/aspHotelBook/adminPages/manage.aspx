    ...
    <fieldset>
        <div class="control-group">
            ...
            <div class="controls">
                ...
                <asp:RequiredFieldValidator runat="server"
                                            ...
                                            ControlToValidate="tbRoomNumber"></asp:RequiredFieldValidator>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                ...
                <asp:RangeValidator runat="server"
                                    ControlToValidate="tbAdults"
                                    ValidationGroup="validationGroup"
                                    ForeColor="Red"
                                    Text="Must be between 1 and 4!"
                                    MinimumValue="1"
                                    MaximumValue="4"></asp:RangeValidator>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                ...
                <asp:RangeValidator runat="server"
                                    ControlToValidate="tbRate"
                                    ValidationGroup="validationGroup"
                                    ForeColor="Red"
                                    Text="Must be between 100 and 500!"
                                    MinimumValue="100"
                                    MaximumValue="500"></asp:RangeValidator>
